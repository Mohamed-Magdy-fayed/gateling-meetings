...
export default {
  ...
  settings: {
    title: "الإعدادات",
    lead: "حسابك ومؤسستك وخطتها والأنظمة المرتبطة بها.",
    account: {
      title: "الحساب",
      lead: "بأي حساب سجّلت الدخول، وكيف تسجّل الدخول.",
  ...
  auth: {
    ...
    passkeys: {
      ...
      list: {
        ...
        emptyLead:
          "أضف مفتاحًا لتسجيل الدخول ببصمتك أو وجهك أو رمز جهازك بدلًا من كلمة المرور.",
      ...
      auth: {
        ...
        error: {
          ...
          noPasskey:
            "لا يوجد مفتاح مرور مرتبط بهذا البريد. سجّل الدخول بكلمة المرور أولًا ثم أضف مفتاحًا من صفحة مفاتيح المرور.",
